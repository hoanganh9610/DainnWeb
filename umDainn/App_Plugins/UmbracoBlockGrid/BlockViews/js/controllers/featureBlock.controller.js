angular.module("umbraco").controller("featureBlockController", function ($scope, globalDesignService, licensesService, editorState) {
    ...
    globalDesignService.getDesignSettings(editorState.getCurrent().id).then(function (design) {
        ...
        $scope.styles = `  
            .card-feature-sm{
                ${getFontStyles('text')}
                color: var(--feature-cards-contrast, #${design.baselineColors.content.text});
            ...
            .section-features{
                color: #${design.baselineColors.content.text}; ${getFontStyles('text')}
            }
